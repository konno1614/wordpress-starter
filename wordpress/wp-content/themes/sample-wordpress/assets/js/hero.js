...
/******/ 	return __webpack_require__(__webpack_require__.s = "./entry-hero.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _js_lib_Animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/lib/Animation */ "./js/lib/Animation.js");
/* harmony import */ var _scss_hero_animation_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scss/hero-animation.scss */ "./scss/hero-animation.scss");
/* harmony import */ var _scss_hero_animation_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_scss_hero_animation_scss__WEBPACK_IMPORTED_MODULE_1__);
...
var Logo = {
  ...
  show: function show() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-animation-logo').addClass('show');
  },
  open: function open() {
    Object(animejs__WEBPACK_IMPORTED_MODULE_1__["default"])({
      targets: '.js-animation-logo-mask',
      points: [Logo.MASK_POINTS.init, // スタート時に下部頂点をずらしておくことで、波をうたないようにする
      {
        value: Logo.MASK_POINTS.start,
        duration: 0
  ...
  scaleup: function scaleup() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-animation-logo').addClass('scaleup');
  }
};
var Texts = {
  selectors: ['.hero-animation__text--01', '.hero-animation__text--02', '.hero-animation__text--03', '.hero-animation__text--04'],
  ...
  splitText: function splitText(el) {
    // テキスト抽出
    var text = el.textContent; // 中身削除

    el.innerHTML = ''; // 1文字つづspanに包む

    var span = document.createElement('span');
    text.split('').forEach(function (str) {
      var cloneSpan = span.cloneNode();
      cloneSpan.textContent = str; // spanをappendしていく

      el.appendChild(cloneSpan);
    });
  },
  init: function init() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.hero-animation__text').each(function (i, el) {
      Texts.splitText(el);
    });
  },
  show: function show() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-animation-text').addClass('show');
    Object(animejs__WEBPACK_IMPORTED_MODULE_1__["default"])({
...
var SVGBg = {
  show: function show() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-svg-bg').addClass('show');
  }
};
var MiniClouds = {
  show: function show() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-mini-clouds').addClass('show');
  }
};
var Header = {
  show: function show() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-header').addClass('visible');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-fixed-guide').addClass('visible');
  }
};
jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').addClass('lock');
Logo.show();
window.addEventListener('load', function () {
  Texts.init();
  var timeline = animejs__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
    duration: 0
  }); // timeline.add({
  //   begin: Logo.show,
  //   duration: 500
